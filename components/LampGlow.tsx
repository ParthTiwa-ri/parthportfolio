      ...
      <div className=" flex flex-col items-center   xl:-mb-40 md:-mb-24 -mb-11  w-full  ">
        <div className="relative  ">
          ...
          <SparklesCore
            ...
            speed={0.1}
            particleDensity={800}
            className="absolute  top-0 z-negative-2 left-1/2 -translate-x-1/2 w-[90%] md:w-3/4 xl:w-1/2  h-full"
            particleColor="#FFFFFF"
          />
          <div className=" absolute left-1/2 -translate-x-1/2 z-2  bg-red-500 blur-2xl md:blur-3xl  top-24 md:top-44  h-48 md:h-[250px] pointer-events-none   w-[800px] "></div>
        </div>
      </div>
    </>
  );
